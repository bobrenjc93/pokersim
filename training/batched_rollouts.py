...
class BatchedRolloutCollector:
    ...
    def _create_game(self) -> Tuple[Any, List[Dict], str, RLStateEncoder]:
        ...
        Uses common.GameConfig and common.create_binding_config for
        consistent game configuration across the codebase.
        """
        # Convert dict config to GameConfig for consistent handling
        game_cfg = GameConfig.from_dict(self.game_config)
        
        # Create binding config using common utility
