...
class RolloutWorker:
    ...
    def initialize(self):
        ...
        from common import create_actor_critic, RLStateEncoder
    ...
    def collect_episode(
        ...
        from common import (
            ...
            RLStateEncoder, estimate_hand_strength,
        )
        ...
        # Use common.create_binding_config for consistent config handling
        ...
        game = self.poker_api.Game(binding_config)
